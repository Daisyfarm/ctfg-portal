...
// 2. Load Leaflet safely (SSR: false is mandatory for Vercel)
...
export default function FarmMap() {
  ...
  // 3. Fetch 122 boxes from Supabase
  useEffect(() => {
  ...
  // 4. Grid Logic: Centered for your Daisy Hill photo
  ...
  return (
    <div style={{ height: '100vh', width: '100%', background: '#000' }}>
      ...
      >
        {/* Your Daisy Hill Photo from /public/map.png */}
