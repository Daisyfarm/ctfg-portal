      ...
      <main style={{ maxWidth: '1280px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
          <div style={{ backgroundColor: '#0f1117', border: '1px solid #27272a', padding: '24px', borderRadius: '12px' }}>
            ...
            <h3 style={{ fontSize: '18px', fontWeight: 900, color: '#ffffff', margin: '8px 0 16px 0' }}>Samuel Founder</h3>
            <div style={{ fontSize: '12px', color: '#a1a1aa' }}>
              <p style={{ margin: '6px 0' }}>Security Clearance: Network Founder (#001)</p>
              <p style={{ margin: '6px 0' }}>Assigned Sector: Judith Plains North & South</p>
              <p style={{ margin: '6px 0' }}>Status: Authorized Administrator</p>
            </div>
          </div>
          ...
          <div style={{ backgroundColor: '#0f1117', border: '1px solid #27272a', padding: '24px', borderRadius: '12px' }}>
            ...
            <div style={{ fontSize: '12px', color: '#a1a1aa' }}>
              <p style={{ margin: '6px 0' }}>Heavy Machinery Overrides: Unlocked</p>
              <p style={{ margin: '6px 0' }}>Treasury Vault Access: Full Control</p>
              <p style={{ margin: '6px 0' }}>Node Dispatch Rights: Active</p>
            </div>
          </div>
        </div>
      </main>
