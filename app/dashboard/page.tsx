...
import { Wallet, Tractor, RefreshCcw, Send, Map, Clock, Cloud, LogOut } from 'lucide-react';
...
export default function Dash() {
  ...
  const btn = { padding:'8px 15px', background:'#1e293b', color:'#fff', border:'none', borderRadius:'8px', cursor:'pointer', fontSize:'12px', fontWeight:'bold' };
