...
import { Wallet, Tractor, Send, Map, Clock, Briefcase, Landmark, LogOut, ChevronDown, Cloud, ShieldCheck, TrendingUp, FileCheck, UserCheck, Megaphone, Trophy, Radio, Star, LifeBuoy, BarChart3, BookOpen } from 'lucide-react';
...
export default function Dash() {
  ...
  const load = async () => {
    ...
    setP(pr); setTx(t || []); setNews(n?.[0]?.message || "System Ready."); setRadio(rd?.[0] || { message: 'Standby', sender: 'Dispatch' });
    setDebt(ln?.reduce((acc:any, curr:any) => acc + curr.amount_remaining, 0) || 0);
