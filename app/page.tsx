  ...
  if (!session) {
    return (
      <div style={{ height: '100vh', width: '100%', position: 'relative', overflow: 'hidden', backgroundColor: '#000', fontFamily: 'monospace' }}>
        ...
        {/* PANNING MOUNTAIN IMAGE (Direct URL version) */}
        <div style={{
          position: 'absolute',
          top: 0,
          left: 0,
        ...
        <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ width: '360px', padding: '45px', backgroundColor: 'rgba(5, 5, 5, 0.9)', border: '1px solid #d4af3733', textAlign: 'center', backdropFilter: 'blur(3px)', boxShadow: '0 0 50px rgba(0,0,0,0.8)' }}>
            ...
            <h2 style={{ color: '#d4af37', letterSpacing: '4px', fontSize: '13px', marginBottom: '35px' }}>DAISY HILL SECURE UPLINK</h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
              <input type="email" placeholder="OPERATIVE EMAIL" value={email} onChange={(e) => setEmail(e.target.value)} style={{ width: '100%', background: '#0a0a0a', border: '1px solid #333', color: '#fff', padding: '14px', fontSize: '11px' }} />
              <input type="password" placeholder="ACCESS KEY" value={password} onChange={(e) => setPassword(e.target.value)} style={{ width: '100%', background: '#0a0a0a', border: '1px solid #333', color: '#fff', padding: '14px', fontSize: '11px' }} />
    ...
    <div style={{ height: '100vh', width: '100%', background: '#050505', display: 'flex', color: 'white', fontFamily: 'monospace' }}>
      ...
      <div style={{ width: '400px', background: '#000', borderLeft: '1px solid #222', padding: '20px' }}>
        <div style={{ border: '1px solid #d4af3744', padding: '20px' }}>
          <div style={{ fontSize: '10px', color: '#d4af37' }}>OPERATIVE STATUS
