...
import { Wallet, Tractor, Send, Map, Clock, Briefcase, Landmark, LogOut, Cloud, ShieldCheck, TrendingUp, FileCheck, UserCheck, LifeBuoy, Trophy, Radio, Megaphone } from 'lucide-react';
          ...
          <div style={{ position:'relative', zIndex:1, padding:'40px', maxWidth:'1100px' }}>
            ...
            <div style={{ display:'flex', gap:'20px', marginBottom:'20px' }}>
              <div style={{ background:'rgba(0,0,0,0.8)', padding:'30px', borderRadius:'4px', width:'400px', borderLeft:'6px solid #4a7ab5' }}>
                <p style={{ margin:0, fontSize:'11px', color:'#888' }}>{p.username}</p>
              ...
              <div style={{ background:'rgba(0,0,0,0.8)', padding:'30px', borderRadius:'4px', width:'300px', borderLeft:'6px solid #22c55e' }}>
                <p style={{ margin:0, fontSize:'11px', color:'#888' }}>SERVER: {s?.server?.name || 'CTFG Montana'}</p>
