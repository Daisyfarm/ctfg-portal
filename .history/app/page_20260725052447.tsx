      ...
      <main style={{ maxWidth: '1280px', margin: '0 auto', padding: '40px 24px' }}>
        ...
        <div style={{ marginBottom: '40px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(360px, 1fr))', gap: '20px' }}>
            {[
              { title: 'Sector 4 - Wheat Harvesting', img: 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?auto=format&fit=crop&w=800&q=80', status: 'Combine Active - 85% Yield' },
              { title: 'North Valley - Corn Sprayer Op', img: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?auto=format&fit=crop&w=800&q=80', status: 'Telemetry Normal - GPS Locked' },
              { title: 'Central Silo & Terminal Hub', img: 'https://images.unsplash.com/photo-1586771107445-d3ca888129ff?auto=format&fit=crop&w=800&q=80', status: 'Unloading Bay 2 - Clear' }
            ].map((feed, idx) => (
